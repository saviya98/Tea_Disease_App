...
ROOT_DIR = os.path.abspath('/content/drive/My Drive/maskrcnn_colab/mrcnn_demo')
...
class CustomConfig(Config):
    def __init__(self, num_classes, steps_epoch=20):
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, annotation_json, images_dir, dataset_type="train"):
        ...
        # self.add_class("coco_like", 1, "Blister")
        # self.add_class("coco_like", 2, "Necrotic_Spot")
