...
import { StyleSheet, TouchableOpacity,Dimensions, View, Text, Button, Image} from "react-native";
...
const BbMap = ({ navigation }) => {
    ...
    return (
        ...
        <Button onPress={() => navigation.navigate('Blister Emergence Date')} title='Blister Emergence Date'></Button>
        </View>
